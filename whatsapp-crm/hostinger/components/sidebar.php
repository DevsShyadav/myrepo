    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <div class="nav-item" id="btn-validate">
                ...
                Validate Numbers
                <span id="validation-status" style="font-size:10px;color:var(--primary);margin-left:auto"></span>
            </div>
        ...
        <div class="nav-section">
            ...
            <div class="nav-item" onclick="window.open('api/get_logs.php?limit=50','_blank')">
