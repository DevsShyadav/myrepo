<section class="chat-panel">
    ...
    <div class="chat-messages" id="chat-messages">
        <div class="empty-state" id="chat-empty">
            <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" style="width:56px;height:56px;color:var(--primary);opacity:0.6">
                <path d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z"/>
            </svg>
            <h3 style="margin-top:16px">WhatsApp CRM</h3>
            <p>Select a lead from the list to view conversation</p>
            <p style="margin-top:12px;font-size:11px;color:var(--text-muted)">Messages will appear here in real-time</p>
        </div>
    </div>
    ...
    <div class="chat-input-area hidden" id="chat-input-area">
        ...
        <button class="btn btn-primary" id="send-btn" title="Send Message">
